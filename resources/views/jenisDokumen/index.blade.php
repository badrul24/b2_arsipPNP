...
@section('content')
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Jenis Dokumen</h2>
            <p class="mt-1 text-sm text-gray-500">Kelola Data Jenis Dokumen</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <form action="{{ route('jenis-dokumen.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
                    ...
                    @foreach ($jenisDokumens as $jenisDokumen)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ $jenisDokumens->firstItem() + $loop->index }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                {{ $jenisDokumen->kode_jenis }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ $jenisDokumen->nama_jenis }}
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-500 max-w-xs">
                                <div class="whitespace-normal break-words">{{ $jenisDokumen->keterangan }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                ...
                                <form action="{{ route('jenis-dokumen.destroy', $jenisDokumen->id) }}" method="POST"
