            ...
            <form action="{{ route('kategori.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="3"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('keterangan') border-red-500 @enderror"
