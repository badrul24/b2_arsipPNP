            ...
            <form action="{{ route('surat_masuk.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_surat_pengirim" id="nomor_surat_pengirim"
                                ...
                                value="{{ old('nomor_surat_pengirim') }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_surat_pengirim" id="tanggal_surat_pengirim"
                                ...
                                value="{{ old('tanggal_surat_pengirim') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="status_surat" id="status_surat"
                                ...
                                <option value="Baru" {{ old('status_surat') == 'Baru' ? 'selected' : '' }}>Baru</option>
                                <option value="Dibaca" {{ old('status_surat') == 'Dibaca' ? 'selected' : '' }}>Dibaca</option>
                                <option value="Dikonfirmasi" {{ old('status_surat') == 'Dikonfirmasi' ? 'selected' : '' }}>Dikonfirmasi</option>
                                <option value="Didisposisi" {{ old('status_surat') == 'Didisposisi' ? 'selected' : '' }}>Didisposisi</option>
                                <option value="Selesai" {{ old('status_surat') == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                <option value="Diarsipkan" {{ old('status_surat') == 'Diarsipkan' ? 'selected' : '' }}>Diarsipkan</option>
                            </select>
                            @error('status_surat')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                ...
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan" rows="3"
                        ...
                        placeholder="Masukkan keterangan surat masuk">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
