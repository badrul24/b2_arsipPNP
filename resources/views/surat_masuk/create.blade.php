            ...
            <form action="{{ route('surat_masuk.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="nomor_surat_pengirim" class="block font-medium text-gray-700 mb-1">Nomor Surat
                                Pengirim</label>
                        ...
                        <div>
                            <label for="tanggal_surat_pengirim" class="block font-medium text-gray-700 mb-1">Tanggal Surat
                                Pengirim</label>
                        ...
                        <div>
                            ...
                            @if ($isDisabled)
                                <input type="hidden" name="jurusan_id"
                                    value="{{ old('jurusan_id', $currentUser->jurusan_id) }}">
                            @endif
                            @error('jurusan_id')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
