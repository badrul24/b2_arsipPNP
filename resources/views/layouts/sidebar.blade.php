...
>
    ...
    <nav class="p-2 space-y-1 overflow-y-auto h-[calc(100vh-5rem)]">
        ...
        <!-- 4. Pengaturan Sistem -->
        <div x-data="{ open: {{ request()->is('user*') || request()->is('jurusan*') ||request()->is('divisi*') || request()->is('log-aktivitas*') ? 'true' : 'false' }} }">
            <button
                @click="open = !open"
                class="flex items-center justify-between w-full px-3 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-gray-900"
            >
            ...
            <div x-show="open && sidebarOpen" class="pl-6 mt-1 space-y-1">
                ...
                <a href="/divisi" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->is('divisi*') ? 'text-primary-700 bg-primary-50' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                    Divisi
