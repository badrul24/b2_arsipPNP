...
@section('content')
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Form Tambah Data Dokumen</p>
        </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <select name="retensi_id" id="retensi_id"
                                ...
                                @foreach($retensis as $retensi)
                                    <option value="{{ $retensi->id }}" {{ old('retensi_id') == $retensi->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="sifat" id="sifat"
                                ...
                                <option value="Sangat Penting" {{ old('sifat') == 'Sangat Penting' ? 'selected' : '' }}>Sangat Penting</option>
                        ...
                        <div>
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="Inaktif" {{ old('status') == 'Inaktif' ? 'selected' : '' }}>Inaktif</option>
                        ...
                        <div>
                            ...
                            <select name="jenis" id="jenis"
                                ...
                                <option value="Memorandum" {{ old('jenis') == 'Memorandum' ? 'selected' : '' }}>Memorandum</option>
                                <option value="Perjanjian" {{ old('jenis') == 'Perjanjian' ? 'selected' : '' }}>Perjanjian</option>
