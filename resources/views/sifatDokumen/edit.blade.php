...
@section('content')
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Edit Sifat Dokumen</h2>
            <p class="mt-1 text-sm text-gray-500">Form Edit Data Sifat Dokumen</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="max-w-xl">
            <form action="{{ route('sifat-dokumen.update', $sifatDokumen->id) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                <div>
                    ...
                    <input type="text" name="kode_sifat"
                        ...
                        value="{{ old('kode_sifat', $sifatDokumen->kode_sifat) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nama_sifat"
                        ...
                        value="{{ old('nama_sifat', $sifatDokumen->nama_sifat) }}"
