...
<body class="min-h-screen flex items-center justify-center py-6 px-4 sm:px-6 lg:px-8 bg-gray-150">
    ...
    <div class="w-full max-w-md relative z-10">
        <div
            class="bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl px-6 pt-6 pb-6 mb-4 border border-gray-200/50 transform transition duration-500 hover:scale-[1.01]">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="flex items-center justify-between text-xs">
                    ...
                    <a href=""
                        class="text-blue-600 hover:text-blue-800 font-medium transition duration-200">Forgot
                        password?</a>
                </div>
            ...
            <div class="mt-4 text-center">
                <p class="text-gray-600 text-xs">Don't have an account? <a href="{{ route('register') }}"
                        class="text-blue-600 hover:text-blue-800 font-medium transition duration-200">Sign up</a></p>
            </div>
        </div>
