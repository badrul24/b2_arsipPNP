  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
    <div class="flex items-center h-16">
      ...
      <div class="flex items-center">
        <img class="h-12 w-auto" src="{{ asset('icons/logo2.png') }}" alt="PNP Logo" />
      ...
      <div class="hidden sm:flex space-x-8 ml-10 h-full items-center">
        ...
        <div
            ...
            <a href="#kontak"
              class="nav-sub-link block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">Kontact</a>
          </div>
        </div>
    ...
    navSubLinks.forEach(link => {
        link.addEventListener('click', function (e) {
            const href = this.getAttribute('href');
                ...
                // ⛔ Hanya cegah jika tidak ada href atau nilainya kosong
